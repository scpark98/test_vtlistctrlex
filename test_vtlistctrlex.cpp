...
// test_vtlistctrlex.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(Ctest_vtlistctrlexApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Ctest_vtlistctrlexApp construction
...
BOOL Ctest_vtlistctrlexApp::InitInstance()
{
